...
class ChannelService:
    ...
    def __init__(
        ...
        post_repo: Optional[PostRepository],
        parser_service: Optional[ParserService],
    ):
    ...
    async def parse_channel(
        ...
        """
        # Получаем или создаем канал через новую функцию
        channel = await self.parse_channel_info(channel_link)
    ...
    async def parse_channel_info(self, channel_link: str) -> Optional[Channel]:
        """
        Получает информацию о канале и создает/возвращает запись в БД.
        """
