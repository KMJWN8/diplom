...
class ClassificationService:
    ...
    def __init__(self, model_path: str = "../ml/LR/logistic_regression_model_russian.pkl"):
        self.model = None
    ...
    def _load_nlp_tools(self):
        ...
        try:
            ...
            additional_stopwords = {
                'это', 'вот', 'ну', 'же', 'ли', 'бы', 'б', 'ведь', 'мол',
                'то', 'таки', 'как', 'так', 'вроде', 'типа', 'прямо',
                'просто', 'сам', 'сама', 'сами', 'само', 'очень'
            }
